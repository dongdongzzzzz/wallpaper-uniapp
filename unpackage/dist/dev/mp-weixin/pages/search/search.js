  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: common_vendor.o(onSearch, "19"),
        b: common_vendor.o(onClear, "72"),
        c: common_vendor.o(onClear, "e7"),
        d: common_vendor.o(($event) => queryParams.value.keyword = $event, "35"),
        e: common_vendor.p({
          focus: true,
          placeholder: "搜索",
        ...
        i: common_vendor.o(removeHistory, "15"),
