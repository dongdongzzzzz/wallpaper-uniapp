...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const swiperChange = (e) => {
      ...
      currentInfo.value = classList.value[currentIndex.value];
      readImgsFun();
      common_vendor.index.__f__("log", "at pages/preview/preview.vue:188", e);
    };
    common_vendor.index.__f__("log", "at pages/preview/preview.vue:193", classList.value);
    const clickInfo = () => {
    ...
    const clickDownload = async () => {
      try {
                      ...
                      common_vendor.index.openSetting({
                        success: (setting) => {
                          common_vendor.index.__f__(
                            "log",
                            "at pages/preview/preview.vue:320",
                            setting
                          );
        ...
        common_vendor.index.__f__("log", "at pages/preview/preview.vue:351", err);
        common_vendor.index.hideLoading();
      }
    };
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        n: common_vendor.o(clickInfo, "75"),
        o: common_vendor.p({
          type: "star",
          size: "28"
        }),
        p: common_vendor.t(currentInfo.value.score),
        q: common_vendor.o(clickScore, "69"),
        r: common_vendor.p({
          type: "download",
          size: "23"
        }),
        s: common_vendor.o(clickDownload, "12")
      } : {}, {
        t: common_vendor.p({
          type: "closeempty",
          size: "18",
        ...
        v: common_vendor.o(clickInfoClose, "15"),
        ...
        G: common_vendor.o(clickScoreClose, "b4"),
        H: common_vendor.o(($event) => userScore.value = $event, "28"),
        I: common_vendor.p({
          allowHalf: true,
        ...
        K: common_vendor.o(submitScore, "b9"),
