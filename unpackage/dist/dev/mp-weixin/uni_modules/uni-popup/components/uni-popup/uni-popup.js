  ...
  methods: {
    ...
    open(direction) {
      ...
      if (!this.config[direction]) {
        common_vendor.index.__f__("error", "at uni_modules/uni-popup/components/uni-popup/uni-popup.vue:279", "缺少类型：", direction);
        return;
      }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.o((...args) => $options.clear && $options.clear(...args), "84"),
